...
### Known warnings
Loading config /code/Mask2Former/configs/cityscapes/panoptic-segmentation/swin/../Base-Cityscapes-PanopticSegmentation.yaml with yaml.unsafe_load. Your machine may be at risk if the file contains malicious content.
